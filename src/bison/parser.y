...
de comandos simples cada um expressao_2inado por ponto-e-vírgula. */
...
um comando simples.*/
comando : comando comando | comando_simples ';' | /*Isso aqui é vazio*/;
...
*/
comando_simples : chamada_de_funcao | declaracao_variavel | atribuicao_variavel | comando_de_retorno | fluxo_if | fluxo_while;

/*
Consiste no tipo da variável seguido de uma lista composta de pelo me-
...
variavel: TK_IDENTIFICADOR | TK_IDENTIFICADOR TK_OC_LE expressao
...
/*
Uma chamada de função consiste no nome da função, seguida de argumentos entre parênteses separados por vírgula. 
Um argumento pode ser uma expressão.
*/
chamada_de_funcao: TK_IDENTIFICADOR '(' argumento ')'
argumento: argumento ',' argumento | expressao | /*Isso é o vazio*/
...
/*Controle de Fluxo*/
/*
A condicional consiste no token if seguido de uma expressão entre parênteses e então por um bloco de
comandos obrigatório. O else, sendo opcional, deve sempre aparecer após o bloco do if, e 
é seguido de um bloco de comandos, obrigatório caso o else seja empregado.
*/
fluxo_if: TK_PR_IF '(' expressao ')' bloco_de_comandos | TK_PR_IF '(' expressao ')' bloco_de_comandos TK_PR_ELSE bloco_de_comandos
...
*/
expressao: expressao TK_OC_OR expressao | expressao_6
expressao_6: expressao_6 TK_OC_AND expressao_6 | expressao_5
expressao_5: expressao_5 TK_OC_EQ expressao_5 | expressao_5 TK_OC_NE expressao_5 | expressao_4
expressao_4: expressao_4 '<' expressao_4 | expressao_4 '>' expressao_4 | expressao_4 TK_OC_LE expressao_4 | expressao_4 TK_OC_GE expressao_4 | expressao_3
expressao_3:expressao_3 '+' expressao_3 | expressao_3 '-' expressao_3 | expressao_2
expressao_2: expressao_2 '*' expressao_2 | expressao_2 '/' expressao_2 | expressao_2 '%' expressao_2 | expressao_1
expressao_1: '-' expressao_terminal | '!' expressao_terminal | expressao_terminal
expressao_terminal: literal | TK_IDENTIFICADOR | chamada_de_funcao | '('expressao')'
...
expressao_terminal tem mais precencia que expressao_2, que tem mais precedencia expr
